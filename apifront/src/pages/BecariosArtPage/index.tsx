...
export function BecariosArtPage() {
  ...
  const regFiltrados = registrados.filter(r => {
                        ...
                        <React.Fragment key={reg.id}>
                          <tr style={{ background: expanded ? 'rgba(59,130,246,0.06)' : undefined }}>
                            ...
                            <td style={{ ...S.td, fontSize: '0.72rem', color: 'rgba(255,255,255,0.5)' }}>
                              {reg.creado_por_nombre ?? `#${reg.creado_por ?? '?'}`}
                            </td>
                            {/* Fecha alta */}
                          ...
                          {expanded && dir && (
                            <tr>
                              <td colSpan={9} style={{ padding: '0 12px 12px 24px', background: 'rgba(59,130,246,0.04)' }}>
