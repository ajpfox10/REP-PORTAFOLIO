...
export class CrearReparticionesDto {
    ...
    @ApiPropertyOptional({ example: '2024-04-01', description: 'Fecha de alta en formato ISO' })
    @IsOptional()
    @IsDateString({}, { message: 'La fecha debe tener formato ISO válido' })
    fechaDeAlta?: Date;

    @ApiPropertyOptional({ example: 'admin@example.com', description: 'Usuario que registra el registro' })
    @IsOptional()
