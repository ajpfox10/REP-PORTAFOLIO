...
export type EventName =
  | "scan.queued"   | "scan.started"  | "scan.page_uploaded"
  | "scan.completed"| "scan.failed"   | "scan.canceled"
  | "ocr.started"   | "ocr.completed" | "ocr.failed"
  | "ai.classified" | "ai.extracted"
  | "index.updated" | "document.created" | "document.deleted"
...
export interface ScanJob {
  id: ScanJobId; tenant_id: TenantId; device_id: DeviceId
  profile_id: number|null; priority: number; status: ScanJobStatus
  page_count: number|null; error_message: string|null
  started_at: string|null; completed_at: string|null; created_at: string
  personal_dni: number|null; personal_ref: string|null
}
