...
CREATE TABLE IF NOT EXISTS scan_profiles (
  ...
  output_format         ENUM('pdf','pdf_a','tiff','jpg') NOT NULL DEFAULT 'pdf',
  created_at            TIMESTAMP NOT NULL DEFAULT CURRENT_TIMESTAMP,
  updated_at            TIMESTAMP NULL ON UPDATE CURRENT_TIMESTAMP,
...
CREATE TABLE IF NOT EXISTS scan_jobs (
  ...
  source         VARCHAR(30) NOT NULL DEFAULT 'flatbed',
  duplex         TINYINT NOT NULL DEFAULT 0,
  dpi            INT NULL,
  color          TINYINT NULL,
  auto_rotate    TINYINT NULL,
  blank_page_detection TINYINT NULL,
  compression    ENUM('low','medium','high') NULL,
  output_format  ENUM('pdf','pdf_a','tiff','jpg') NULL,
